...
public class MainForm {
    ...
    private JLabel scp;
    private JSpinner spinnerThreadsNumber;
    ...
    public void init() {
        ...
        //spinnerThreadsNumber.addChangeListener(actionEvent -> C.spinnerThreadsNumberEvent());
    ...
    private void createUIComponents() {
        ...
        //spinnerThreadsNumber = new JSpinner(new SpinnerNumberModel(1,1,32,1));
        spinnerThreadsNumber.setValue(1);
    }
